                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context)
                                  .getText('xbio5sl1' /* Nelly Kids Fashion */),
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context)
                                  .getText('8esi4lfs' /* Nilly Fabricato */),
                              style: FlutterFlowTheme.of(context)
                                  .titleLarge
                                  .override(
                                    fontFamily: 'NellyFont',
